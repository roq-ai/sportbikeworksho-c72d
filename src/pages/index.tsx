...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`sportbikeworkshop`}</title>

        <meta
          name="description"
          content="Welcome to SportBikeWorkshop, where you can effortlessly book appointments for your bike service and be matched with a dedicated service engineer."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1421429167374-8fc8ab6d0f66?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiaWtlJTIwc2VydmljZXxlbnwwfHx8fDE2OTY0OTY5MzF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@wayneb250?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Wayne Bishop`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to SportBikeWorkshop, where you can effortlessly book appointments for your bike service and be matched with a dedicated service engineer.`}
            </Text>
            <Box
