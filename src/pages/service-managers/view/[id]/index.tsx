...
import { getServiceManagerById } from 'apiSdk/service-managers';
...
function ServiceManagerViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ServiceManagerInterface>(
    () => (id ? `/service-managers/${id}` : null),
    () =>
      getServiceManagerById(id, {
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Management Level" text={data?.management_level} />
