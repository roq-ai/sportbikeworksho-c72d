...
import { createServiceEngineer } from 'apiSdk/service-engineers';
...
function ServiceEngineerCreatePage() {
  ...
  const handleSubmit = async (values: ServiceEngineerInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createServiceEngineer(values);
      resetForm();
