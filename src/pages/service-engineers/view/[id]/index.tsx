...
import { getServiceEngineerById } from 'apiSdk/service-engineers';
import { ServiceEngineerInterface } from 'interfaces/service-engineer';

function ServiceEngineerViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Service Engineer Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('service_engineer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/service-engineers/edit/${id}`} passHref legacyBehavior>
                    <Button
