...
export function AppointmentListPage(props: AppointmentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getAppointments({
        relations: ['user', 'bike', 'service_engineer.count', 'service_manager.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('bike', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('service_engineer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'service_engineer',
          header: 'Service Engineer',
          accessorKey: 'service_engineer',
          cell: ({ row: { original: record } }: any) => record?._count?.service_engineer,
        }
      : null,
    hasAccess('service_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'service_manager',
          header: 'Service Manager',
          accessorKey: 'service_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.service_manager,
        }
      : null,
