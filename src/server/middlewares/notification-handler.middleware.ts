...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Service Request Created.create': {
    roles: ['business-owner', 'service-manager', 'service-engineer', 'customer-service-representative'],
    key: 'service_request',
    tenantPath: [],
    userPath: [],
  },
  'Service Request Updated.update': {
    roles: ['business-owner', 'service-manager', 'customer-service-representative'],
    key: 'service_update',
    tenantPath: [],
    userPath: [],
  },
  'Customer Feedback Received.create': {
    roles: ['business-owner', 'service-manager', 'customer-service-representative'],
